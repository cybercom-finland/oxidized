    ...
    def pagination(data, node_want)
      ...
      if @cfg.pagination?
        ...
        loop do
          ...
          raise Oxidized::OxidizedError, "if using pagination, 'hosts_location' setting must be set" unless @cfg.hosts_location?
          node_data += string_navigate(data, @cfg.hosts_location)
